...
export const TRANSLATIONS = {
  en: {
    ...
    queryPlaceholder: "Describe your legal issue (e.g. 'Someone scammed me ₹15,000 on UPI', 'Landlord refusing deposit', 'Police refusing FIR')...",
    speakBtn: "Speak (Hindi / English)",
    submitBtn: "Analyze Legal Rights",
    quickScenarios: "Common Scenarios",
    decisionHeader: "Single Clear Action Recommendation",
    statutoryRef: "Statutory References (BNS / IPC / Acts)"
  },
  hi: {
    appTitle: "न्यायमित्र",
    ...
    queryPlaceholder: "अपनी कानूनी समस्या बताएं (जैसे: 'UPI पर ₹5000 की धोखाधड़ी हुई', 'मकान मालिक डिपॉजिट नहीं लौटा रहा', 'पुलिस FIR नहीं लिख रही')...",
    speakBtn: "बोलें (आवाज़ से पूछें)",
    submitBtn: "अधिकारों का विश्लेषण करें",
    quickScenarios: "प्रमुख कानूनी मुद्दे",
    decisionHeader: "सर्वोत्तम व्यावहारिक कानूनी कदम",
    statutoryRef: "प्रासंगिक कानूनी धाराएं (BNS / IPC)"
  },
  ta: {
    appTitle: "நியாயமித்ரா",
    appSubtitle: "இந்திய சட்டத்திற்கான AI சட்ட உதவியாளர்",
    badgeLaw: "IPC & BNS 2023 விதிமுறைகள்",
    emergencyBar: "சைபர் மோசடி? உடனடியாக 1930 ஐ அழைக்கவும் | காவல்: 112",
    disclaimer: "இது பொதுவான சட்ட வழிகாட்டல் மட்டுமே. வழக்கறிஞரின் ஆலோசனைக்கு இது மாற்றாகாது.",
    tabs: {
      query: "சட்ட கேள்வி",
      autoFir: "FIR ஜெனரேட்டர்",
      docExplainer: "ஆவண விளக்கம்",
      cyber: "சைபர் உதவி (1930)",
      rights: "குடிமக்கள் உரிமை",
      policeLocator: "காவல் நிலையம்",
      lawyerAid: "இலவச சட்ட உதவி"
    },
    queryPlaceholder: "உங்கள் சட்ட சிக்கலை விவரிக்கவும்...",
    speakBtn: "பேசவும்",
    submitBtn: "பகுப்பாய்வு செய்",
    quickScenarios: "முக்கிய வழக்குகள்",
    decisionHeader: "பரிந்துரைக்கப்பட்ட நடவடிக்கை",
    statutoryRef: "சட்டப்பிரிவுகள்"
  },
  te: {
    appTitle: "న్యాయమిత్ర",
    appSubtitle: "భారతీయ చట్టం కోసం AI లీగల్ అసిస్టెంట్",
    badgeLaw: "IPC & BNS 2023 అనుగుణంగా",
    emergencyBar: "సైబర్ మోసమా? వెంటనే 1930కి కాల్ చేయండి | పోలీస్: 112",
    disclaimer: "ఇది కేవలం చట్టపరమైన అవగాహన కొరకు మాత్రమే. ఇది న్యాయవాది సలహాకు ప్రత్యామ్నాయం కాదు.",
    tabs: {
      query: "లీగల్ ప్రశ్న",
      ...
      rights: "పౌర హక్కులు",
      policeLocator: "పోలీస్ స్టేషన్లు",
      lawyerAid: "ఉచిత న్యాయ సహాయం"
    },
    queryPlaceholder: "మీ సమస్యను తెలపండి...",
    speakBtn: "మాట్లాడండి",
    submitBtn: "పరిష్కారం కనుగొనండి",
    quickScenarios: "సాధారణ సమస్యలు",
    decisionHeader: "స్పష్టమైన సిఫార్సు",
    statutoryRef: "చట్ట నిబంధనలు"
  },
  bn: {
    appTitle: "ন্যায়মিত্র",
    appSubtitle: "ভারতীয় আইনের জন্য AI আইনি সহায়ক",
    badgeLaw: "IPC ও BNS 2023 অনুযায়ী",
    emergencyBar: "সাইবার জালিয়াতি? অবিলম্বে 1930 ডায়াল করুন | পুলিশ: 112",
    disclaimer: "এটি সাধারণ আইনি দিকনির্দেশনা ও সচেতনতার জন্য। এটি কোনো আইনজীবীর বিকল্প নয়।",
    tabs: {
      query: "আইনি প্রশ্ন",
      autoFir: "অটো FIR জেনারেটর",
      docExplainer: "দলিল ব্যাখ্যা",
      cyber: "সাইবার হেল্পলাইন",
      rights: "নাগরিক অধিকার",
      policeLocator: "থানা ও সাইবার সেল",
      lawyerAid: "আইনি সহায়তা"
    },
    queryPlaceholder: "আপনার আইনি সমস্যা লিখুন...",
    speakBtn: "বলুন",
    submitBtn: "আইনি বিশ্লেষণ",
    quickScenarios: "সাধারণ কেস",
    decisionHeader: "একমাত্র সঠিক আইনি পদক্ষেপ",
    statutoryRef: "আইন ও ধারা"
  },
  mr: {
    appTitle: "न्यायमित्र",
    appSubtitle: "भारतीय कायद्यासाठी AI विधी सहाय्यक",
    badgeLaw: "IPC व BNS 2023 चे नियम",
    emergencyBar: "सायबर फसवणूक? त्वरित 1930 वर कॉल करा | पोलीस: 112",
    disclaimer: "हे केवळ कायदेशीर जागरूकता आणि मार्गदर्शनासाठी आहे. हे वकिलाच्या सल्ल्याचा पर्याय नाही.",
    tabs: {
      query: "कायदेशीर प्रश्न",
      autoFir: "ऑटो FIR जनरेटर",
      docExplainer: "करारनामा विश्लेषण",
      cyber: "सायबर मदत (1930)",
      rights: "नागरिक हक्क",
      policeLocator: "पोलीस ठाणे",
      lawyerAid: "मोफत कायदेशीर मदत"
    },
    queryPlaceholder: "तुमची कायदेशीर समस्या लिहा...",
    speakBtn: "बोला",
    submitBtn: "विश्लेषण करा",
    quickScenarios: "प्रमुख प्रकरणे",
    decisionHeader: "योग्य कायदेशीर पाऊल",
    statutoryRef: "संबंधित कलमे"
  },
  gu: {
    appTitle: "ન્યાયમિત્ર",
    appSubtitle: "ભારતીય કાયદા માટે AI કાનૂની સહાયક",
    badgeLaw: "IPC અને BNS 2023 સુસંગત",
    emergencyBar: "સાયબર છેતરપિંડી? તરત 1930 પર કૉલ કરો | પોલીસ: 112",
    disclaimer: "આ માત્ર કાનૂની માર્ગદર્શન માટે છે. વકીલની સલાહનો વિકલ્પ નથી.",
    tabs: {
      query: "કાનૂની પ્રશ્ન",
      ...
      policeLocator: "પોલીસ સ્ટેશન",
      lawyerAid: "કાનૂની સહાય"
    },
    queryPlaceholder: "તમારી સમસ્યા જણાવો...",
    speakBtn: "બોલો",
    submitBtn: "વિશ્લેષણ કરો",
    quickScenarios: "મુખ્ય બાબતો",
    decisionHeader: "યોગ્ય કાનૂની પગલું",
    statutoryRef: "કાયદાની કલમો"
  },
  kn: {
    appTitle: "ನ್ಯಾಯಮಿತ್ರ",
    appSubtitle: "ಭಾರತೀಯ ಕಾನೂನಿಗಾಗಿ AI ಕಾನೂನು ಸಹಾಯಕ",
    badgeLaw: "IPC ಮತ್ತು BNS 2023 ನಿಯಮಾವಳಿ",
    emergencyBar: "ಸೈಬರ್ ವಂಚನೆ? ತಕ್ಷಣ 1930 ಗೆ ಕರೆ ಮಾಡಿ | ಪೊಲೀಸ್: 112",
    disclaimer: "ಇದು ಕೇವಲ ಕಾನೂನು ಜಾಗೃತಿಗಾಗಿ ಮಾತ್ರ. ವಕೀಲರ ಸಲಹೆಗೆ ಇದು ಬದಲಿಯಲ್ಲ.",
    tabs: {
      query: "ಕಾನೂನು ಪ್ರಶ್ನೆ",
      autoFir: "ಆಟೋ FIR ಜನರೇಟರ್",
      docExplainer: "ದಾಖಲೆ ವಿವರಣೆ",
      cyber: "ಸೈಬರ್ ಸಹಾಯವಾಣಿ (1930)",
      rights: "ನಾಗರಿಕ ಹಕ್ಕುಗಳು",
      policeLocator: "ಪೊಲೀಸ್ ಠಾಣೆಗಳು",
      lawyerAid: "ಉಚಿತ ಕಾನೂನು ನೆರವು"
    },
    queryPlaceholder: "ನಿಮ್ಮ ಕಾನೂನು ಸಮಸ್ಯೆಯನ್ನು ವಿವರಿಸಿ...",
    speakBtn: "ಮಾತನಾಡಿ",
    submitBtn: "ವಿಶ್ಲೇಷಿಸಿ",
    quickScenarios: "ಪ್ರಮುಖ ಪ್ರಕರಣಗಳು",
    decisionHeader: "ಸೂಕ್ತ ಕಾನೂನು ಕ್ರಮ",
    statutoryRef: "ಕಾನೂನು ವಿಭಾಗಗಳು"
  }
};
